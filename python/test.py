...
if __name__ == '__main__':
	...
	S = Susan(path + "02.png", mask ="mask9", compare="naive")
	S.detect_edges_mp(t, filename = path + "bordercond2", nms=True, thin=True, heatmap=True, geometric=False, corners = False)

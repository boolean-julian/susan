...
\chapter{Der SUSAN Kantendetektor}
		...
		\subsection{Non-Maximum-Suppression}\label{ssec:nonmax}
			...
			\begin{figure}[H]\centering
				...
				\begin{tikzpicture}[fill=black, text=white]
					...
					\normalsize
				\end{tikzpicture}
				\caption{Eingangsbild wie in Abbildung \ref{fig:noborder}. Links sind die Kantenrichtungen abgebildet und klassifiziert wie wir noch in Sektion \ref{ssec:nonmax_implem} besprechen werden. Rechts wurde das Bild durch die Non-Maximum-Suppression wurde die Kante pixelgenau lokalisiert.}
			\end{figure}
	...
	S.detect_edges_mp(t)
		...
		\section{Vergleich mit dem Kantendetektor von Canny}
			...
			In Abbildung \ref{fig:canny_no_corners} ist dieser Unterschied gut zu erkennen.
		...
		\chapter{Diskussion}
			Der SUSAN-Kantendetektor findet Kanten auf digitalen Bildern pixelgenau, wie wir an mehreren Beispielen erkennen konnten. 

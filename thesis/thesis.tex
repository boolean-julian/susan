		...
		\subsection{Non-Maximum-Suppression}\label{ssec:nonmax}
			...
			\begin{figure}[H]
				\begin{center}
					...
					\caption{Inter-Pixel und Intra-Pixel Fall}
				\end{center}
			\end{figure}

			Um die Richtung der Kante zu bestimmen, müssen wir zunächst jede Antwort in eine der zwei Fälle einsortieren, danach können wir die Richtung bestimmen:
